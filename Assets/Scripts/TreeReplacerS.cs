...
// Source: https://gist.github.com/st4rdog/a9f9542db32505389b3cf428c7c195c9
[ExecuteInEditMode]
public class TreeReplacerS : EditorWindow {
	...
	public void Convert()
	{
		...
		for (int i = 0; i < data.treeInstances.Length; i++)
		{
			...
			{
				Instantiate(_tree, position, Quaternion.Euler(0, Random.Range(0, 360), 0), parent.transform);
			}
		}
	}
